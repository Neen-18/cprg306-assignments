...
export default function Page() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center gap-4">
      ...
      {user && <Link href="/week-10/shopping-list" className="font-mono text-2xl border border-white px-4 py-2 rounded-full hover:bg-white hover:text-black transition-colors">
      Go to Shopping List →
      </Link>}
